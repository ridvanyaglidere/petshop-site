<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="petshopint2.WebForm8" %>
...
<head runat="server">
    ...
    <title>appingPetShop - Anasayfa</title>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <li> <a class="nav-link" href="Hakkimizda.aspx">hakkımızda</a></li>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <h1>Hoş Geldiniz!</h1>
            <h2 class="text-center mb-4" style="color: #FF69B4;">Ürünlerimiz</h2>
                    ...
                    <ItemTemplate>
                        <div class="col-md-4 mb-4">
                            <div class="product-card">
                                <img src='<%# Eval("ResimYolu") %>' alt='<%# Eval("UrunAdi") %>' />
                                <h5><%# Eval("UrunAdi") %></h5>
                                ...
                                <asp:Button ID="btnDetay" runat="server" Text="Detay" CssClass="btn-details" OnClick="btnDetay_Click" CommandArgument='<%# Eval("UrunID") %>' />
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
