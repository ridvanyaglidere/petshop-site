<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="petshopint2.WebForm3" %>
...
<head>
    ...
    <title>PetShop Otomasyonu - Kullanıcı Girişi</title>
    ...
    <style>
        ...
        .paw-1 { top: 10px; left: 20px; transform: rotateizosyal medya bağlantıları ile ilgili bilgi verebilir misiniz?deg); }
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <asp:LinkButton ID="btnKullaniciGirisNav" runat="server" CssClass="nav-link active" OnClick="btnKullaniciGiris_Click">Kullanıcı Girişi</asp:LinkButton>
                        </li>
                        <li class="nav-item">
                            <asp:LinkButton ID="btnUyeOlNav" runat="server" CssClass="nav-link" OnClick="btnUyeOl_Click">Kayıt Ol</asp:LinkButton>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <h3 class="mb-4">PetShop Kullanıcı Girişi</h3>
            <div class="mb-3">
            ...
            <div class="d-grid gap-2">
                <asp:Button ID="Button1" runat="server" Text="Giriş Yap" CssClass="btn btn-custom-orange" OnClick="Button1_Click" />
            </div>
            <div class="mt-3">
        ...
        <script>
            ...
            // Animasyonu yalnızca giriş denemesi sonrası tetikle
